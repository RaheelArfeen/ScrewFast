        ...
        <nav className={navbarClasses}>
                ...
                <div className={`transition-all duration-300 overflow-hidden ${isMobileMenuOpen ? 'max-h-96' : 'max-h-10'}`}>
                    <div className='flex items-center justify-between'>
                      <div className="logo flex md:hidden">
                        ...
                        <div className='gap-[18px] md:hidden flex'>
                            <button onClick={toggleMobileMenu} className="p-2 rounded-full hover:bg-yellow-100 dark:hover:bg-neutral-700 text-[#525252] dark:text-[#a1a1a1] transition md:hidden">
                                {isMobileMenuOpen ? <X size={20} /> : <AlignJustify size={20} />}
                            </button>

                            <button onClick={() => setDarkMode(!darkMode)} className="p-2 rounded-full hover:bg-[#e5e5e5] dark:hover:bg-neutral-700 text-[#525252] transition hover:text-[#F46E3A] dark:text-[#a1a1a1] cursor-pointer">
                    ...
                    <div className='transition-all duration-300 flex md:hidden'>
                        <div className="nav mt-5 flex flex-col gap-x-0 gap-y-4 md:mt-0 md:flex-row md:items-center md:justify-end md:gap-x-4 lg:gap-x-7 md:gap-y-0 md:ps-7">

                            {navLink}

                            <button onClick={() => {setShowSignUp(true), setShowSignIn(true)}} className="flex items-center gap-x-2 text-base md:text-sm font-medium cursor-pointer text-neutral-600 dark:text-neutral-400 transition duration-300 hover:text-orange-500 md:border-s dark:border-neutral-700 md:border-neutral-300 md:pl-6 2xl:text-base">
                                <svg className="h-4 w-4 flex-shrink-0" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            ...
                            <div className="relative inline-flex">
                                <button className="inline-flex items-center gap-x-2 cursor-pointer rounded-lg px-1.5 py-1.5 text-sm font-medium text-neutral-600 dark:text-neutral-400 transition duration-300 hover:bg-neutral-700 hover:text-orange-500 outline-none">
                                    <svg className="w-4 h-4 flex-shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="m20.893 13.393-1.135-1.135a2.252 2.252 0 0 1-.421-.585l-1.08-2.16a.414.414 0 0 0-.663-.107.827.827 0 0 1-.812.21l-1.273-.363a.89.89 0 0 0-.738 1.595l.587.39c.59.395.674 1.23.172 1.732l-.2.2c-.212.212-.33.498-.33.796v.41c0 .409-.11.809-.32 1.158l-1.315 2.191a2.11 2.11 0 0 1-1.81 1.025 1.055 1.055 0 0 1-1.055-1.055v-1.172c0-.92-.56-1.747-1.414-2.089l-.655-.261a2.25 2.25 0 0 1-1.383-2.46l.007-.042a2.25 2.25 0 0 1 .29-.787l.09-.15a2.25 2.25 0 0 1 2.37-1.048l1.178.236a1.125 1.125 0 0 0 1.302-.795l.208-.73a1.125 1.125 0 0 0-.578-1.315l-.665-.332-.091.091a2.25 2.25 0 0 1-1.591.659h-.18c-.249 0-.487.1-.662.274a.931.931 0 0 1-1.458-1.137l1.411-2.353a2.25 2.25 0 0 0 .286-.76m11.928 9.869A9 9 0 0 0 8.965 3.525m11.928 9.868A9 9 0 1 1 8.965 3.525" className=""></path></svg>
                                    <svg className="size-4 hs-dropdown-open:rotate-180" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m6 9 6 6 6-6"></path></svg>
                                </button>
                            </div>
                        </div>
                    </div>
            ...
            <div className="hidden grow basis-full overflow-hidden transition-all duration-300 md:block">
                <div className="nav mt-5 flex flex-col gap-x-0 gap-y-4 md:mt-0 md:flex-row md:items-center md:justify-end md:gap-x-4 lg:gap-x-7 md:gap-y-0 md:ps-7">
                    ...
                    <div className="relative inline-flex">
                        <button className="inline-flex items-center gap-x-2 cursor-pointer rounded-lg px-1.5 py-1.5 text-sm font-medium text-neutral-600 dark:text-neutral-400 transition duration-300 hover:bg-[#e5e5e5] dark:hover:bg-neutral-700 hover:text-orange-500 outline-none">
                            <svg className="w-4 h-4 flex-shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="m20.893 13.393-1.135-1.135a2.252 2.252 0 0 1-.421-.585l-1.08-2.16a.414.414 0 0 0-.663-.107.827.827 0 0 1-.812.21l-1.273-.363a.89.89 0 0 0-.738 1.595l.587.39c.59.395.674 1.23.172 1.732l-.2.2c-.212.212-.33.498-.33.796v.41c0 .409-.11.809-.32 1.158l-1.315 2.191a2.11 2.11 0 0 1-1.81 1.025 1.055 1.055 0 0 1-1.055-1.055v-1.172c0-.92-.56-1.747-1.414-2.089l-.655-.261a2.25 2.25 0 0 1-1.383-2.46l.007-.042a2.25 2.25 0 0 1 .29-.787l.09-.15a2.25 2.25 0 0 1 2.37-1.048l1.178.236a1.125 1.125 0 0 0 1.302-.795l.208-.73a1.125 1.125 0 0 0-.578-1.315l-.665-.332-.091.091a2.25 2.25 0 0 1-1.591.659h-.18c-.249 0-.487.1-.662.274a.931.931 0 0 1-1.458-1.137l1.411-2.353a2.25 2.25 0 0 0 .286-.76m11.928 9.869A9 9 0 0 0 8.965 3.525m11.928 9.868A9 9 0 1 1 8.965 3.525" className=""></path></svg>
                            <svg className="size-4 hs-dropdown-open:rotate-180" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m6 9 6 6 6-6"></path></svg>
                        </button>
                    </div>
